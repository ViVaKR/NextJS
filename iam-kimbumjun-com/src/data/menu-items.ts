...
export const getMembershipItems = (): IMenu[] => {
    return [
        ...
        { id: 6, title: '회원가입', url: '/membership/sign-up', icon: 'manage_accounts', param: null, hideWhenAuth: true, sessionMenu: false },
        { id: 7, title: '로그인', url: '/membership/sign-in', icon: 'manage_accounts', param: null, hideWhenAuth: true, sessionMenu: false },
        { id: 8, title: '로그아웃', url: '/membership/sign-out', icon: 'manage_accounts', param: null, requiresAuth: true, sessionMenu: true },
    ];
};
