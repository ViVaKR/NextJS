...
export const getOddsItems = (): IMenu[] => {
    return [
        ...
        { id: 2, title: '쉘실행기', url: '/odds/code-runner' },
        { id: 3, title: '그리드뷰', url: '/odds/grid-control' },
        { id: 4, title: '코드서식', url: '/odds/code-html' },
        { id: 5, title: '단계', url: '/odds/stepper-text' },
        { id: 6, title: '스넥바', url: '/odds/snack-bar' },
        { id: 7, title: '카드', url: '/odds/card' },
        { id: 8, title: '박스', url: '/odds/box' },
        { id: 9, title: '데모(ORM)', url: '/odds/orm-demo' },
        { id: 10, title: 'MUI Grid', url: '/odds/mui-grid' },
        { id: 11, title: 'MUI Container', url: '/odds/mui-container' },
        { id: 12, title: 'CRUD', url: '/odds/crud' },
        { id: 13, title: 'Accordion', url: '/odds/accordion' },
        { id: 14, title: 'Tooltip', url: '/odds/tooltip' },
        { id: 15, title: 'TextField', url: '/odds/text-field' },
        { id: 16, title: 'Button', url: '/odds/button' },
        { id: 17, title: 'Checkbox', url: '/odds/checkbox' },
        { id: 18, title: 'DataGrid A', url: '/odds/data-grid' },
        { id: 19, title: 'DataGrid B', url: '/odds/data-grid-2' },
        { id: 20, title: 'Badge', url: '/odds/badge' },
        { id: 21, title: 'Avata', url: '/odds/avata' },
        { id: 22, title: 'Backdrop', url: '/odds/backdrop' },
        { id: 22, title: 'Screen Dialog', url: '/odds/screen-dialog' },
        { id: 23, title: 'Scroll Dialog', url: '/odds/scroll-dialog' },
        { id: 24, title: 'Progress', url: '/odds/progress' },
        { id: 25, title: 'Snackbar', url: '/odds/snackbar' },
    ]
}
