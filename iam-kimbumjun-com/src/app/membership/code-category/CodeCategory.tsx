...
import { Box, Container, CssBaseline, IconButton, TextField, Typography } from '@mui/material';
...
const CodeCategory = () => {
    ...
    const fetchCategories = useCallback(async (signal: AbortSignal) => {
        ...
        try {
            ...
            if (isMounted && error.name !== 'AbortError') { // 요청 취소 에러는 무시
