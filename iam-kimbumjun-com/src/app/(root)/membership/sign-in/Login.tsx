...
export default function SignIn() {
  ...
  return (
    ...
    border-slate-600">
              ...
              {/* <p className='text-xs text-slate-400 place-self-center'>{domain || null}</p> */}
        ...
        font-bold"
                  ...
                  <div className='flex justify-evenly text-xs mb-4 items-center'>
        ...
        font-bold"
                ...
                <Link href={`https://vivabm.com/membership/sign-in`}
